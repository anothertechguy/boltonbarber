    ...
    <footer class="bg-[#111111] py-16 border-t border-white/5">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="mt-8 flex justify-center w-full pb-4">
                <a href="https://easycheapwebsites.com" aria-label="Website Designer easycheapwebsites.com" target="_blank" rel="noopener noreferrer" class="text-slate-500 hover:text-primary transition-colors text-[11px] font-bold tracking-[0.2em] uppercase flex items-center justify-center gap-1 group">
                    MADE WITH ❤️ BY easycheapwebsites.com <span class="animate-pulse text-primary group-hover:text-white">_</span>
                </a>
            </div>
        </div>
